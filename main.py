"""Модуль введения данных о персонаже, выборе специальности, прокачке."""
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция предложения тренировки и выбора атака/защита."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора имени и вида персонажа."""
